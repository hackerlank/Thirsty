...
TEST(Conv, Type2Type) 
{
    ...
    StringPiece spV("StringPiece");
    EXPECT_EQ(to<StringPiece>(spV), "StringPiece");
    ...
    EXPECT_EQ(to<StringPiece>(StringPiece("Forty Two")),
        "Forty Two");
}
...
void testString2Integral() 
{
    ...
    for (auto i = 0; i < sizeof(strings) / sizeof(*strings); i++) {
    ...
    for (auto i = 0; i < sizeof(uStrings) / sizeof(*uStrings); i++) {
    ...
    if (sizeof(Int) >= 4) {
        ...
        for (auto i = 0; i < sizeof(strings2) / sizeof(*strings2); i++) {
        ...
        for (auto i = 0; i < sizeof(uStrings2) / sizeof(*uStrings2); i++) {
    ...
    if (sizeof(Int) >= 8) {
        ...
        for (auto i = 0; i < sizeof(strings3) / sizeof(*strings3); i++) {
        ...
        for (auto i = 0; i < sizeof(uStrings3) / sizeof(*uStrings3); i++) {
    ...
    for (auto i = 0; i < sizeof(strings4) / sizeof(*strings4); i++) {
