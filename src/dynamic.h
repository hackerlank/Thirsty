// Copyright (C) 2015 chenqiang@outlook.com. All rights reserved.
...
public:
     ...
     */
    /* implicit */  dynamic(std::nullptr_t = nullptr);
    /* implicit */  dynamic(bool value);
    /* implicit */  dynamic(int64_t value);

    /*
     * Delegating constructors
     */
    /* implicit */ dynamic(uint64_t value) : dynamic(int64_t(value)) {}
    /* implicit */ dynamic(uint32_t value) : dynamic(int64_t(value)) {}
    /* implicit */ dynamic(int32_t value) : dynamic(int64_t(value)) {}
    /* implicit */ dynamic(uint16_t value) : dynamic(int64_t(value)) {}
    /* implicit */ dynamic(int16_t value) : dynamic(int64_t(value)) {}
    /* implicit */ dynamic(uint8_t value) : dynamic(int64_t(value)) {}
    /* implicit */ dynamic(int8_t value) : dynamic(int64_t(value)) {}

    /* implicit */ dynamic(double value);
    /* implicit */ dynamic(float value) : dynamic(double(value)) {}

    /*
     * String compatibility constructors.
     */
    /* implicit */ dynamic(const char* s, size_t count);
    /* implicit */ dynamic(std::string&& s);
    /* implicit */ dynamic(const std::string& s) : dynamic(s.c_str(), s.size()) {}
    /* implicit */ dynamic(const char* s) : dynamic(s, strlen(s)) {}
